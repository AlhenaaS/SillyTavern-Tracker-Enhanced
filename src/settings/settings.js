...
const staticLocalizationBindings = [
	...
	{ element: () => settingsRootElement?.querySelector('label[for="tracker_enhanced_show_popup_for"] + br + small'), key: "settings.show_popup_for.help", target: "html" },
	{ element: () => settingsRootElement?.querySelector('label[for="tracker_enhanced_format"]'), key: "settings.format.label" },
	{ element: () => settingsRootElement?.querySelector('label[for="tracker_enhanced_format"] + br + small'), key: "settings.format.help", target: "html" },
	...
	{ element: () => settingsRootElement?.querySelector('.tracker-prompt-maker-block > small'), key: "settings.prompt_maker.help", target: "html" },
